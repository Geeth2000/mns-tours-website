        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              <span className="text-2xl font-bold text-primary-500">M&S Tours</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/tours" className="text-gray-700 hover:text-primary-500 transition">
              Tours
            </Link>
            <Link to="/vehicles" className="text-gray-700 hover:text-primary-500 transition">
              Vehicles
            </Link>

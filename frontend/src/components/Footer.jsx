    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold text-primary-400 mb-4">M&S Tours</h3>
            <p className="text-gray-400 mb-4">
              Your trusted partner for exploring the beautiful island of Sri Lanka.
              Creating memorable travel experiences since 2020.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/tours" className="text-gray-400 hover:text-primary-400 transition">
                  Tours
                </Link>
              </li>
              <li>
                <Link to="/vehicles" className="text-gray-400 hover:text-primary-400 transition">
                  Vehicles
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} M&S Tours. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
